...
class MetaNet(fewrel.fewshot_re_kit.framework.FewShotREModel):
    ...
    def __init__(self, N, K, embedding, max_length, hidden_size=230):
        ...
        '''
        fewrel.fewshot_re_kit.framework.FewShotREModel.__init__(self, None)
